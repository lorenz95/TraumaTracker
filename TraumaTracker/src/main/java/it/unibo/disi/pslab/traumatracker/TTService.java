...
import it.unibo.disi.pslab.util.Commands;
...
//		this.config = config;
	...
	private void initResources() {
		...
		// statistics		
		router.get("/gt2/traumatracker/api/stats/numTraumiMonth").handler(this::handleGetNumTraumaMonth);
		router.get("/gt2/traumatracker/api/stats/numTraumiWeek").handler(this::handleGetNumTraumaWeek);  
		router.get("/gt2/traumatracker/api/stats/numTraumaDay").handler(this::handleGetNumTraumaDay); 
		
		router.get("/gt2/traumatracker/api/stats/numAvarageTraumaTime").handler(this::handleGetAvarageTraumaTime);
		router.get("/gt2/traumatracker/api/stats/numAvarageTimeRoom").handler(this::handleGetAvarageTimeRoom); // ok
		router.get("/gt2/traumatracker/api/stats/numFinalDestination").handler(this::handleGetNumFinalDestination);
		
		router.get("/gt2/traumatracker/api/stats/consumptionTypeDrug").handler(this::handleGetConsumptionTypeDrug);
		router.get("/gt2/traumatracker/api/stats/numMaxProcedure").handler(this::handleGetMaxProcedure);
